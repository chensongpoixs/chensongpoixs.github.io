...
public:
  void complete(const int& ec, std::size_t bytes)
  {
    ...
    func_(this, ec, bytes);  // call_back -->do_complete
  }
protected:
...
class reactive_op_base : public operation
{
public:
  ...
  static bool do_perform(operation * base)
  {
...
![](https://github.com/chensongpoixs/chensongpoixs.github.io/blob/master/img/2019-01-22/operaction.gif?raw=true)
