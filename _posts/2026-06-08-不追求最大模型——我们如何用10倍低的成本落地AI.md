...
>尤其有一个项目[clude_code项目AI编程助手](https://chensongpoixs.github.io/clude_code/)，提示词我改了几十遍，稍微换一下输入说法，大模型输出的结果就出问题，特别折腾。
...
[2、clude_code: 项目AI编程助手](https://chensongpoixs.github.io/clude_code/)
