...
```
// g++ -o cpthread cthread.cpp -lpthread
#include <stdlib.h>
#include <stdio.h>
#include <unistd.h>
#include <pthread.h>
...
![](https://github.com/chensongpoixs/blog_img/blob/master/blog/2017-10-26/img/boost_thread_create_auto_ptr.png?raw=true)


## 结语


看别人的库时, 要有一些基本知识. 才知道怎么分析别人的库是你要的功能
